...
定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2887
...
> **\_TextProperties**(`index`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> **\_TextProperties**(`name`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> `readonly` **moreOption**: [`_TextMoreOptions`](TextMoreOptions.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2890
...
> `readonly` **pathOption**: [`_TextPathOptions`](TextPathOptions.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2889
...
定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2888
