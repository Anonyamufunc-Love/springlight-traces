...
定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2893
...
> **\_TextPathOptions**(`index`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> **\_TextPathOptions**(`name`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> `readonly` **path**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2894
