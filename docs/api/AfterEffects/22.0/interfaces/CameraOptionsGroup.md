# 接口: \_CameraOptionsGroup()

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2699
...
> **\_CameraOptionsGroup**(`index`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> **\_CameraOptionsGroup**(`name`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> `readonly` **aperture**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2703

***

### blurLevel

> `readonly` **blurLevel**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2704
...
> `readonly` **depthOfField**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2701
...
> `readonly` **focusDistance**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2702

***

### highlightGain

> `readonly` **highlightGain**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2710

***

### highlightSaturation

> `readonly` **highlightSaturation**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2712

***

### highlightThreshold

> `readonly` **highlightThreshold**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2711

***

### irisAspectRatio

> `readonly` **irisAspectRatio**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2708

***

### irisDiffractionFringe

> `readonly` **irisDiffractionFringe**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2709

***

### irisRotation

> `readonly` **irisRotation**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2706

***

### irisRoundness

> `readonly` **irisRoundness**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2707

***

### irisShape

> `readonly` **irisShape**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2705
...
> `readonly` **zoom**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2700
