# 接口: UnknownPropertyType

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:1888
...
> `readonly` **essentialPropertySource**: `null` \| [`AVLayer`](../classes/AVLayer.md) \| [`Property`](../classes/Property.md)\<`UnknownPropertyType`\>
...
> **propertyValueType**: [`PropertyValueType`](../enumerations/PropertyValueType.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:1889
...
定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:1890
