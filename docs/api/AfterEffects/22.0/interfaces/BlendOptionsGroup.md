# 接口: \_BlendOptionsGroup()

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2728
...
> **\_BlendOptionsGroup**(`index`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> **\_BlendOptionsGroup**(`name`): [`_PropertyClasses`](../type-aliases/PropertyClasses.md)
...
> `readonly` **advancedBlending**: [`_AdvBlendGroup`](AdvBlendGroup.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2731
...
> `readonly` **globalLightAltitude**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2730

***

### globalLightAngle

> `readonly` **globalLightAngle**: [`OneDProperty`](../type-aliases/OneDProperty.md)

定义于: types-for-adobe/AfterEffects/22.0/index.d.ts:2729
